...
namespace CShark_ReScale01
{
    public partial class Main : Form
    {
        ...
        private dynamic LoadOrCreateSettings()
        {
            ...
            {
                File.WriteAllText(RootFile, JsonConvert.SerializeObject(DefaultSettings, Formatting.Indented));
                return JObject.Parse(JsonConvert.SerializeObject(DefaultSettings));
            }
        }
